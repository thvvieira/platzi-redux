...
var getTimezoneOffsetInMilliseconds = __webpack_require__(157)
var isDate = __webpack_require__(158)
...
/* Registration */
var EDIT_USER_DETAILS = exports.EDIT_USER_DETAILS = 'EDIT_USER_DETAILS';
...
/* Feed */
var UPDATE_NEW_POST_TEXT = exports.UPDATE_NEW_POST_TEXT = 'UPDATE_NEW_POST_TEXT';
var UPDATE_POST_TIMESTAMP = exports.UPDATE_POST_TIMESTAMP = 'UPDATE_POST_TIMESTAMP';
var SHOW_ALERT = exports.SHOW_ALERT = 'SHOW_ALERT';
var UNSET_POST_CREATED_FLAG = exports.UNSET_POST_CREATED_FLAG = 'UNSET_POST_CREATED_FLAG';
var CREATE_NEW_POST_REQUEST = exports.CREATE_NEW_POST_REQUEST = 'CREATE_NEW_POST_REQUEST';
var CREATE_NEW_POST_SUCCESS = exports.CREATE_NEW_POST_SUCCESS = 'CREATE_NEW_POST_SUCCESS';
var CREATE_NEW_POST_FAILURE = exports.CREATE_NEW_POST_FAILURE = 'CREATE_NEW_POST_FAILURE';
...
/* Post */
var UPDATE_NEW_COMMENT_TEXT = exports.UPDATE_NEW_COMMENT_TEXT = 'UPDATE_NEW_COMMENT_TEXT';
var UPDATE_NEW_REPLY_TEXT = exports.UPDATE_NEW_REPLY_TEXT = 'UPDATE_NEW_REPLY_TEXT';
var CREATE_NEW_COMMENT_REQUEST = exports.CREATE_NEW_COMMENT_REQUEST = 'CREATE_NEW_COMMENT_REQUEST';
var CREATE_NEW_COMMENT_SUCCESS = exports.CREATE_NEW_COMMENT_SUCCESS = 'CREATE_NEW_COMMENT_SUCCESS';
var CREATE_NEW_COMMENT_FAILURE = exports.CREATE_NEW_COMMENT_FAILURE = 'CREATE_NEW_COMMENT_FAILURE';
...
var FETCH_POST_FAILURE = exports.FETCH_POST_FAILURE = 'FETCH_POST_FAILURE';

var FETCH_COMMENTS_REQUEST = exports.FETCH_COMMENTS_REQUEST = 'FETCH_COMMENTS_REQUEST';
var FETCH_COMMENTS_SUCCESS = exports.FETCH_COMMENTS_SUCCESS = 'FETCH_COMMENTS_SUCCESS';
var FETCH_COMMENTS_FAILURE = exports.FETCH_COMMENTS_FAILURE = 'FETCH_COMMENTS_FAILURE';

var FETCH_REPLIES_REQUEST = exports.FETCH_REPLIES_REQUEST = 'FETCH_REPLIES_REQUEST';
var FETCH_REPLIES_SUCCESS = exports.FETCH_REPLIES_SUCCESS = 'FETCH_REPLIES_SUCCESS';
var FETCH_REPLIES_FAILURE = exports.FETCH_REPLIES_FAILURE = 'FETCH_REPLIES_FAILURE';

var CREATE_NEW_REPLY_REQUEST = exports.CREATE_NEW_REPLY_REQUEST = 'CREATE_NEW_REPLY_REQUEST';
var CREATE_NEW_REPLY_SUCCESS = exports.CREATE_NEW_REPLY_SUCCESS = 'CREATE_NEW_REPLY_SUCCESS';
var CREATE_NEW_REPLY_FAILURE = exports.CREATE_NEW_REPLY_FAILURE = 'CREATE_NEW_REPLY_FAILURE';
...
var fetchUserToken = function fetchUserToken() {
...
var requireAuthentication = exports.requireAuthentication = function requireAuthentication() {
...
var redirectIfAuthenticated = exports.redirectIfAuthenticated = function redirectIfAuthenticated() {
  var token = fetchUserToken();
  if (token) {
    return true;
  }
...
var purgeToken = exports.purgeToken = function purgeToken() {
  var store = window.localStorage;
  if (!store) {
    return null;
  }
...
var getToken = exports.getToken = fetchUserToken;
...
var binary = __webpack_require__(135);
...
var Creator = function Creator(_ref) {
  ...
  return _react2.default.createElement(
    'form',
    { className: (0, _classnames2.default)('card', _index2.default.container), onSubmit: createHandler },
    _react2.default.createElement('textarea', {
      type: 'text',
      name: name,
      className: _index2.default['post-text'],
      placeholder: placeholder,
      onChange: handleInputChange,
      value: value
    }),
    _react2.default.createElement('input', { type: 'submit', value: btnText, className: 'btn btn-primary mtb10' })
  );
};
...
var _distance_in_words_to_now = __webpack_require__(38);
...
function PostItem(_ref) {
  ...
  var postPermalink = '/post/' + id;
  var userPermalink = '/user/' + username;
  return _react2.default.createElement(
    'div',
    { className: (0, _classnames2.default)('card mtb20', _index2.default.item) },
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'span',
        null,
        ' | ' + (0, _distance_in_words_to_now2.default)(new Date(createdAt)) + ' ago'
      )
    ),
    _react2.default.createElement(
      'div',
      { className: (0, _classnames2.default)('mtb40', _index2.default.text) },
      text
    ),
    id ? _react2.default.createElement(
      'div',
      { className: _index2.default['comments-cta'] },
      _react2.default.createElement(
        _reactRouterDom.Link,
        { to: postPermalink },
        'View Comments (' + count + ')'
...
var distanceInWords = __webpack_require__(155)
...
exports.emittedNewPost = emittedNewPost;
exports.showNewPostsAlert = showNewPostsAlert;
exports.refreshTimeStamps = refreshTimeStamps;
...
function updateNewPostText(value) {
  return {
...
function createNewPost() {
  return function (dispatch, getState) {
    var token = (0, _authorization.getToken)();
    var newPostText = getState().Feed.newPostText;
    ...
    _axios2.default.create({
      ...
      return dispatch(createNewPostSuccess(response.data));
...
function fetchPosts(author) {
  var authorQuery = author ? '&author=' + author : '';

  return function (dispatch) {
    dispatch(fetchPostsRequest());
    _axios2.default.get('/api/posts?max_time=' + Date.now() + authorQuery).then(function (response) {
...
function editUserDetails(key, value) {
  return {
...
function createUser() {
  return function (dispatch, getState) {
    var _getState$User = getState().User,
        ...
        passwordConfirm = _getState$User.passwordConfirm;
    ...
    _axios2.default.post('/api/signup', {
      ...
      (0, _authorization.setToken)(token);
...
var _Register = __webpack_require__(196);
...
var APP_CONTAINER_NAME = 'app-container';
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouterDom.Route, {
          ...
          render: function render() {
            return (0, _authorization.requireAuthentication)() ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/login' }) : _react2.default.createElement(_Feed2.default, null);
          }
        }),
        _react2.default.createElement(_reactRouterDom.Route, {
          exact: true,
          path: '/register',
          render: function render() {
            return (0, _authorization.redirectIfAuthenticated)() ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/' }) : _react2.default.createElement(_Register2.default, null);
          }
        }),
        _react2.default.createElement(_reactRouterDom.Route, {
          exact: true,
          path: '/login',
          render: function render() {
            return (0, _authorization.redirectIfAuthenticated)() ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/' }) : _react2.default.createElement(_Login2.default, null);
          }
        }),
        _react2.default.createElement(_reactRouterDom.Route, {
          exact: true,
          ...
          render: function render(props) {
            return (0, _authorization.requireAuthentication)() ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/login' }) : _react2.default.createElement(_Profile2.default, props);
          }
        }),
        _react2.default.createElement(_reactRouterDom.Route, {
          exact: true,
          path: '/post/:post_id',
          render: function render(props) {
            return (0, _authorization.requireAuthentication)() ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/login' }) : _react2.default.createElement(_Post2.default, props);
          }
        })
      )
    )
...
window.addEventListener('DOMContentLoaded', function () {
  var appContainer = document.getElementById(APP_CONTAINER_NAME);
  ...
  (0, _reactDom.render)(_react2.default.createElement(App, null), appContainer);
});
...
var _PostItem = __webpack_require__(37);

var _PostItem2 = _interopRequireDefault(_PostItem);

var _feedActions = __webpack_require__(72);
...
window.smoothScrollTop = function (duration, offset) {
  ...
  var elementY = 0 - offset;
  var targetY = document.body.scrollHeight - elementY < window.innerHeight ? document.body.scrollHeight - window.innerHeight : elementY;
  var diff = targetY - startingY;

  var easing = function easing(t) {
    // eslint-disable-line
    return t < 0.5 ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1; // eslint-disable-line no-mixed-operators
  };
  var start = void 0;
...
var FeedContainer = function (_Component) {
  ...
  function FeedContainer(args) {
    _classCallCheck(this, FeedContainer);

    var _this = _possibleConstructorReturn(this, (FeedContainer.__proto__ || Object.getPrototypeOf(FeedContainer)).call(this, args));

    _this.socket = (0, _socket2.default)();
    _this.handlePostCreatorInputChange = _this.handlePostCreatorInputChange.bind(_this);
    _this.handleCreatePost = _this.handleCreatePost.bind(_this);
    _this.handleLogout = _this.handleLogout.bind(_this);
    _this.refreshTimeline = _this.refreshTimeline.bind(_this);

    _this.state = {
      refreshInterval: null
    };

    _this.socket.on('fetchNewPost', function (data) {
      if (data) {
        _this.props.dispatch((0, _feedActions.showNewPostsAlert)());
      }
    });
    return _this;
  }
  ...
  _createClass(FeedContainer, [{
    ...
    value: function componentWillMount() {
      ...
      this.props.dispatch((0, _feedActions.fetchPosts)());
      if (!this.state.refreshInterval) {
        var refreshInterval = setInterval(function () {
          _this2.props.dispatch((0, _feedActions.refreshTimeStamps)());
        }, 60000);
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.props.feed.postCreated === false && nextProps.feed.postCreated === true) {
        ...
        this.props.dispatch((0, _feedActions.emittedNewPost)());
      }
    }
  }, {
    ...
    key: 'handlePostCreatorInputChange',
    value: function handlePostCreatorInputChange(event) {
      if (event.target.name === 'post') {
        this.props.dispatch((0, _feedActions.updateNewPostText)(event.target.value));
      }
    }
  }, {
    key: 'refreshTimeline',
    value: function refreshTimeline(event) {
    ...
    value: function handleCreatePost(event) {
      event.preventDefault();
      this.props.dispatch((0, _feedActions.createNewPost)());
    }
  }, {
    key: 'handleLogout',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.feed.showNewPostAlert ? _react2.default.createElement(
          'div',
          {
            className: (0, _classnames2.default)(_index2.default['floating-alert'], 'btn btn-primary'),
        ...
        _react2.default.createElement('input', { value: 'Log Out', onClick: this.handleLogout, className: 'mtb30 btn btn-primary' }),
        _react2.default.createElement(
          'div',
          null,
          this.props.feed.error
        ),
        _react2.default.createElement(_Creator2.default, {
          name: 'post',
        ...
        this.props.feed.posts.map(function (_ref) {
          var username = _ref.username,
              id = _ref._id,
              createdAt = _ref.created_at,
              text = _ref.text,
              count = _ref.comments_count;
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(FeedContainer);
...
if (typeof WebSocket !== 'undefined') {
  ...
  try {
    NodeWebSocket = __webpack_require__(150);
  } catch (e) { }
}
...
module.exports = {"container":"_2Nttt","floating-alert":"_1yRcm"};
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"MJg-r"};

/***/ }),
/* 155 */
/***/ (function(module, exports, __webpack_require__) {

var compareDesc = __webpack_require__(156)
var parse = __webpack_require__(13)
var differenceInSeconds = __webpack_require__(159)
var differenceInMonths = __webpack_require__(161)
var enLocale = __webpack_require__(164)
...
var differenceInMilliseconds = __webpack_require__(160)
...
var parse = __webpack_require__(13)
var differenceInCalendarMonths = __webpack_require__(162)
var compareAsc = __webpack_require__(163)
...
var buildDistanceInWordsLocale = __webpack_require__(165)
var buildFormatLocale = __webpack_require__(166)
...
// removed by extract-text-webpack-plugin
module.exports = {"item":"_34nxl","header":"OoCt9","text":"oUen4"};
...
var ProfileContainer = function (_Component) {
  ...
  function ProfileContainer(args) {
    _classCallCheck(this, ProfileContainer);

    var _this = _possibleConstructorReturn(this, (ProfileContainer.__proto__ || Object.getPrototypeOf(ProfileContainer)).call(this, args));
  ...
  _createClass(ProfileContainer, [{
    ...
    value: function componentWillMount() {
      ...
      var author = this.props.match.params.user_id;

      this.props.dispatch((0, _feedActions.fetchPosts)(author));
      if (!this.state.refreshInterval) {
        var refreshInterval = setInterval(function () {
          _this2.props.dispatch((0, _feedActions.refreshTimeStamps)());
        }, 60000);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: '/', className: (0, _classnames2.default)('mtb20 back') },
          'Go Back'
        ),
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(
          'h1',
          { className: (0, _classnames2.default)('mtb20') },
          'Viewing posts for : ' + this.props.match.params.user_id
        ),
        this.props.feed.posts.map(function (_ref) {
          var username = _ref.username,
              id = _ref._id,
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"_1AnyM"};
...
var _postActions = __webpack_require__(195);
...
var PostContainer = function (_Component) {
  ...
  function PostContainer(args) {
    _classCallCheck(this, PostContainer);

    var _this = _possibleConstructorReturn(this, (PostContainer.__proto__ || Object.getPrototypeOf(PostContainer)).call(this, args));

    _this.handleCommentCreatorInputChange = _this.handleCommentCreatorInputChange.bind(_this);
    _this.handleCreateComment = _this.handleCreateComment.bind(_this);
    _this.handleReplyRequest = _this.handleReplyRequest.bind(_this);
    _this.updateNewReply = _this.updateNewReply.bind(_this);
    _this.createNewReply = _this.createNewReply.bind(_this);
    return _this;
  }
  ...
  _createClass(PostContainer, [{
    ...
    value: function componentWillMount() {
      ...
      this.props.dispatch((0, _postActions.fetchPost)(postId));
      this.props.dispatch((0, _postActions.fetchComments)(postId));
    }
  }, {
    key: 'handleCommentCreatorInputChange',
    value: function handleCommentCreatorInputChange(event) {
      if (event.target.name === 'comment') {
        this.props.dispatch((0, _postActions.updateNewCommentText)(event.target.value));
      }
    }
  }, {
    key: 'handleCreateComment',
    value: function handleCreateComment(event) {
      var postId = this.props.match.params.post_id;

      event.preventDefault();
      this.props.dispatch((0, _postActions.createNewComment)(postId));
    }
  }, {
    key: 'handleReplyRequest',
    value: function handleReplyRequest(commentId, event) {
      event.preventDefault();
      this.props.dispatch((0, _postActions.fetchReplies)(commentId));
    }
  }, {
    key: 'updateNewReply',
    value: function updateNewReply(commentId, event) {
      if (event && event.target && event.target.value) {
        this.props.dispatch((0, _postActions.updateNewReply)(commentId, event.target.value));
      }
    }
  }, {
    key: 'createNewReply',
    value: function createNewReply(commentId, text, event) {
      event.preventDefault();
      this.props.dispatch((0, _postActions.createNewReply)(commentId, text));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: _index2.default.comments },
          this.props.post.comments.map(function (_ref) {
            var username = _ref.username,
                id = _ref._id,
                createdAt = _ref.created_at,
                text = _ref.text,
                replies = _ref.replies,
                newReplyText = _ref.newReplyText,
                count = _ref.replies_count;
            return _react2.default.createElement(_Comment2.default, {
              ...
              createdAt: createdAt,
              text: text,
              handleReplyRequest: _this2.handleReplyRequest,
              replies: replies,
              newReplyText: newReplyText,
              updateNewReply: _this2.updateNewReply,
              createNewReply: _this2.createNewReply
            });
          }),
          _react2.default.createElement(
            'div',
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"_2mseP","comments":"_2bw0h"};
...
var _Replies = __webpack_require__(192);
...
var Comment = function Comment(_ref) {
  var username = _ref.username,
      ...
      createdAt = _ref.createdAt,
      text = _ref.text,
      handleReplyRequest = _ref.handleReplyRequest,
      replies = _ref.replies,
      newReplyText = _ref.newReplyText,
      updateNewReply = _ref.updateNewReply,
      createNewReply = _ref.createNewReply,
      count = _ref.count;

  var userPermalink = '/user/' + username;
  return _react2.default.createElement(
    'div',
    { className: (0, _classnames2.default)('ptb10', _index2.default.item) },
    _react2.default.createElement(
      'div',
      { className: _index2.default.header },
      _react2.default.createElement(
      ...
      _react2.default.createElement(
        'span',
        { className: _index2.default.separated },
        (0, _distance_in_words_to_now2.default)(new Date(createdAt)) + ' ago'
      ),
      _react2.default.createElement(
        'span',
        ...
        _react2.default.createElement(
          ...
          { onClick: function onClick(event) {
              return handleReplyRequest(id, event);
            }, role: 'link', tabIndex: '-1' },
          'View Replies (' + (count || 0) + ')'
        )
      )
    ),
    _react2.default.createElement(
      'div',
      { className: (0, _classnames2.default)('ptb10', _index2.default.text) },
      text
    ),
    replies ? _react2.default.createElement(_Replies2.default, {
      commentId: id,
      newReplyText: newReplyText,
      updateNewReply: updateNewReply,
      createNewReply: createNewReply,
      replies: replies,
      className: _index2.default.replies
    }) : null
  );
};
...
function Replies(_ref) {
  var commentId = _ref.commentId,
      replies = _ref.replies,
      _ref$newReplyText = _ref.newReplyText,
      newReplyText = _ref$newReplyText === undefined ? '' : _ref$newReplyText,
      updateNewReply = _ref.updateNewReply,
      createNewReply = _ref.createNewReply,
  ...
  return _react2.default.createElement(
    'div',
    { className: (0, _classnames2.default)(className, 'mtb20') },
    replies ? replies.map(function (reply) {
      return _react2.default.createElement(
        'div',
        { key: reply._id, className: (0, _classnames2.default)('ptb10', _index2.default.reply) },
        _react2.default.createElement(
          'div',
          { className: _index2.default.header },
          _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: _index2.default.separated },
            (0, _distance_in_words_to_now2.default)(new Date(reply.created_at)) + ' ago'
          )
        ),
        _react2.default.createElement(
          'div',
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_Creator2.default, {
        ...
        createHandler: function createHandler(event) {
          return createNewReply(commentId, newReplyText, event);
        },
        handleInputChange: function handleInputChange(event) {
          return updateNewReply(commentId, event);
        }
      })
    )
  );
...
// removed by extract-text-webpack-plugin
module.exports = {"reply":"_3zamX","header":"_3JWVl","separated":"_1Lq3J","text":"_3DpDR"};
...
// removed by extract-text-webpack-plugin
module.exports = {"item":"_2SnEf","header":"_1bx7b","separated":"yFIYZ","text":"_306uM","replies":"eEESf"};
...
exports.updateNewCommentText = updateNewCommentText;
exports.updateNewReply = updateNewReply;
...
function updateNewCommentText(value) {
  return {
...
function updateNewReply(commentId, value) {
  return {
...
function createNewComment(postId) {
  return function (dispatch, getState) {
    var token = (0, _authorization.getToken)();
    var newCommentText = getState().Post.newCommentText;
    ...
    _axios2.default.create({
      ...
      return dispatch(createNewCommentSuccess(response.data));
    }).catch(function (error) {
      if (error.response && error.response.data) {
...
function fetchPost(postId) {
  return function (dispatch) {
    ...
    _axios2.default.get('/api/posts/' + postId).then(function (response) {
      return dispatch(fetchPostSuccess(response.data && response.data.post));
    }).catch(function (error) {
      if (error.response && error.response.data) {
...
function fetchComments(postId) {
  return function (dispatch) {
    ...
    _axios2.default.get('/api/posts/' + postId + '/comments').then(function (response) {
...
function fetchReplies(commentId) {
  return function (dispatch) {
    ...
    _axios2.default.get('/api/comments/' + commentId + '/replies').then(function (response) {
      return dispatch(fetchRepliesSuccess(response.data));
    }).catch(function (error) {
      if (error.response && error.response.data) {
...
function createNewReply(commentId, text) {
  return function (dispatch) {
    ...
    _axios2.default.create({
      ...
      return dispatch(createNewReplySuccess(response.data));
    }).catch(function (error) {
      if (error.response && error.response.data) {
...
var _userActionCreators = __webpack_require__(78);
...
var RegisterContainer = function (_Component) {
  ...
  function RegisterContainer(args) {
    _classCallCheck(this, RegisterContainer);

    var _this = _possibleConstructorReturn(this, (RegisterContainer.__proto__ || Object.getPrototypeOf(RegisterContainer)).call(this, args));
  ...
  _createClass(RegisterContainer, [{
    ...
    value: function handleRegister(e) {
      e.preventDefault();
      this.props.dispatch((0, _userActionCreators.createUser)());
    }
  }, {
    key: 'handleChange',
    value: function handleChange(event) {
      ...
      this.props.dispatch((0, _userActionCreators.editUserDetails)(key, value));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: this.handleRegister, className: 'card' },
          _react2.default.createElement(
            'h1',
            { className: (0, _classnames2.default)('mtb10', _index2.default.heading) },
            'Register'
          ),
          ...
          _react2.default.createElement('input', {
            type: 'submit',
            value: 'Register',
            className: (0, _classnames2.default)('btn btn-primary mtb10', _index2.default['register-button'])
          }),
          ...
          _react2.default.createElement(
            'div',
            { className: (0, _classnames2.default)('mtb10', _index2.default.cta) },
            _react2.default.createElement(
              'p',
              null,
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(RegisterContainer);
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"_3cey6","register-button":"_3F6z1","heading":"_2YgN0","cta":"_2_0s-"};
...
var LoginContainer = function (_Component) {
  ...
  function LoginContainer(args) {
    _classCallCheck(this, LoginContainer);

    var _this = _possibleConstructorReturn(this, (LoginContainer.__proto__ || Object.getPrototypeOf(LoginContainer)).call(this, args));
  ...
  _createClass(LoginContainer, [{
    ...
    value: function handleLogin(e) {
      e.preventDefault();
      this.props.dispatch((0, _userActionCreators.loginUser)());
    }
  }, {
    key: 'handleChange',
    value: function handleChange(event) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { onSubmit: this.handleLogin, className: 'card' },
          _react2.default.createElement(
            'h1',
            { className: (0, _classnames2.default)('mtb10', _index2.default.heading) },
            'Login'
          ...
          _react2.default.createElement('input', {
            type: 'submit',
            value: 'Login',
            className: (0, _classnames2.default)('btn btn-primary mtb10', _index2.default['login-button'])
          }),
          this.props.user.message ? _react2.default.createElement(
            'div',
            null,
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"_3nrkz","login-button":"_25XNM","heading":"_1unl1","cta":"_2vAVv"};
...
exports.default = (0, _redux.createStore)(_reducers2.default, window.__REDUX_DEVTOOLS_EXTENSION__ // eslint-disable-line no-underscore-dangle
...
var _FeedReducer = __webpack_require__(202);

var _FeedReducer2 = _interopRequireDefault(_FeedReducer);

var _ProfileReducer = __webpack_require__(203);

var _ProfileReducer2 = _interopRequireDefault(_ProfileReducer);

var _PostReducer = __webpack_require__(204);

var _PostReducer2 = _interopRequireDefault(_PostReducer);

var _UserReducer = __webpack_require__(205);
    ...
    case actions.CREATE_NEW_POST_SUCCESS:
      {
        newState = _extends({}, state, {
          creating: false,
          fetching: false,
          posts: [action.data].concat(_toConsumableArray(state.posts)),
          newPostText: '',
          error: false,
          postCreated: true,
          message: null
...
function reducer() {
  ...
  switch (action.type) {
    ...
    case actions.CREATE_NEW_COMMENT_SUCCESS:
      {
        newState = _extends({}, state, {
          creating: false,
          fetching: false,
          comments: [].concat(_toConsumableArray(state.comments), [action.data.comment]),
          newCommentText: '',
          error: false,
          message: null
        });
    ...
    case actions.CREATE_NEW_REPLY_SUCCESS:
      {
        newState = _extends({}, state, {
          comments: state.comments.map(function (comment) {
            if (comment._id === action.data.comment_id) {
              // eslint-disable-line no-underscore-dangle
              return _extends({}, comment, {
                creatingReply: false,
                newReplyText: '',
                replies: [action.data.reply].concat(_toConsumableArray(comment.replies))
              });
            }
            return comment;
          }),
    ...
    case actions.FETCH_COMMENTS_SUCCESS:
      {
        newState = _extends({}, state, {
          comments: [].concat(_toConsumableArray(action.data.comments)),
          fetchingComments: false
        });
        break;
      }
        ...
        newState = _extends({}, state, {
          comments: state.comments.map(function (comment) {
            if (comment._id === action.data.comment_id) {
              // eslint-disable-line no-underscore-dangle
              return _extends({}, comment, {
                replies: [].concat(_toConsumableArray(action.data.replies)),
...
function reducer() {
  ...
  switch (action.type) {
    case actions.EDIT_USER_DETAILS:
      {
        newState = _extends({}, state, _defineProperty({}, action.key, action.value));
        break;
      }
